...
# ================================================
    ...
    search_value = st.text_input("اكتب كلمة البحث", placeholder="للاسم: اكتب الاسم | للرقم: اكتب الرقم والسنة مثال 1234 2024")
    ...
    if st.button("🔍 بحث", use_container_width=True, type="primary"):
        if not search_value.strip():
            ...
            for case in data["cases"]:
                ...
                elif "الطعن بالنقض" in search_type: # <-- مظبوطة
            ...
            if not results:
                ...
                for idx, case in enumerate(results, 1):
                    ...
                    # زر فتح القضية
                    if st.button("📂 فتح القضية", key=f"open_search_{case['id']}", use_container_width=True):
