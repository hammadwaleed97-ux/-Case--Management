...
# ================================================
    ...
    with st.form("form_case"):
        ...
        st.markdown("<div class='card-title' style='color:#D4AF37; font-size:20px; font-weight:900'>1- بيانات المحكمة</div>", unsafe_allow_html=True)
        محكمة_اسم = st.text_input("اسم المحكمة")
        مأمورية = st.text_input("المأمورية") if نوع == "استئناف" else ""
        st.markdown("</div>", unsafe_allow_html=True)

        st.markdown("<div style='background:#1E2A47; padding:15px; border-radius:15px; border:2px solid #D4AF37; margin-bottom:15px'>", unsafe_allow_html=True)
        st.markdown("<div class='card-title' style='color:#D4AF37; font-size:20px; font-weight:900'>2- بيانات الدعوى</div>", unsafe_allow_html=True)
        col1, col2 = st.columns(2)
        ...
        st.markdown("<div style='background:#1E2A47; padding:15px; border-radius:15px; border:2px solid #D4AF37; margin-bottom:15px'>", unsafe_allow_html=True)
        st.markdown("<div class='card-title' style='color:#D4AF37; font-size:20px; font-weight:900'>3- بيانات الخصوم</div>", unsafe_allow_html=True)
        col1, col2 = st.columns(2)
        ...
        st.markdown("<div style='background:#1E2A47; padding:15px; border-radius:15px; border:2px solid #D4AF37; margin-bottom:15px'>", unsafe_allow_html=True)
        st.markdown("<div class='card-title' style='color:#D4AF37; font-size:20px; font-weight:900'>4- بيانات الجلسة</div>", unsafe_allow_html=True)
        col1, col2 = st.columns(2)
        ...
        st.markdown("<div style='background:#1E2A47; padding:15px; border-radius:15px; border:2px solid #D4AF37; margin-bottom:15px'>", unsafe_allow_html=True)
        st.markdown("<div class='card-title' style='color:#D4AF37; font-size:20px; font-weight:900'>5- المستندات</div>", unsafe_allow_html=True)
        col1, col2 = st.columns(2)
        ...
        st.markdown("<div style='background:#1E2A47; padding:15px; border-radius:15px; border:2px solid #D4AF37; margin-bottom:15px'>", unsafe_allow_html=True)
        st.markdown("<div class='card-title' style='color:#D4AF37; font-size:20px; font-weight:900'>6- الحكم</div>", unsafe_allow_html=True)
        مسندة_ل = st.selectbox("صحيفة الدعوى", ["صحيفة الدعوى"]) # <-- اتعدلت زي ما طلبت
        st.markdown("</div>", unsafe_allow_html=True)
