...
if st.session_state.page == "الرئيسية":
    ...
    if not data["cases"]:
        ...
        for idx, case in enumerate(sorted_cases, 1):
            ...
            # لو المدعي فيه كلمة الهيئة يبقى احمر
    ...
    if st.button("العودة للرئيسية", key="btn_back_3"): st.session_state.page = "الرئيسية"; st.rerun()
    ...
    if st.button("العودة للرئيسية", key="btn_back_4"): st.session_state.page = "الرئيسية"; st.rerun()
elif st.session_state.page == "تقارير":
    st.markdown("<h2 style='color:#C9A961; text-align:center'>التقارير</h2>", unsafe_allow_html=True)
    if st.button("العودة للرئيسية", key="btn_back_5"): st.session_state.page = "الرئيسية"; st.rerun()
elif st.session_state.page == "ارشيف":
    st.markdown("<h2 style='color:#C9A961; text-align:center'>الارشيف</h2>", unsafe_allow_html=True)
    if st.button("العودة للرئيسية", key="btn_back_6"): st.session_state.page = "الرئيسية"; st.rerun()
    ...
    if st.button("العودة للرئيسية", key="btn_back_7"): st.session_state.page = "الرئيسية"; st.rerun()
elif st.session_state.page == "احصائيات":
    st.markdown("<h2 style='color:#C9A961; text-align:center'>الاحصائيات</h2>", unsafe_allow_html=True)
    if st.button("العودة للرئيسية", key="btn_back_8"): st.session_state.page = "الرئيسية"; st.rerun()
