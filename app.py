...
# ==================================================================
    ...
    if not data["cases"]:
        ...
        st.markdown("<table class='case-table'><thead><tr><th>م</th><th>الرقم والسنة</th><th>المحكمة والدائرة</th><th>الخصوم</th><th>الموضوع</th><th>اخر جلسة</th><th>السبب</th><th>الحالة</th><th>فتح</th></tr></thead><tbody>", unsafe_allow_html=True)
        ...
        for idx, case in enumerate(sorted_cases, 1):
            ...
            # الزرار الاحمر الصغير جوه الجدول
            btn = f"<form action='' method='get'><button style='background:#8B0000; color:#FFD700; border:2px solid #FFD700; padding:4px 10px; border-radius:6px; font-weight:700; font-size:12px; cursor:pointer;'>فتح</button><input type='hidden' name='page' value='تفاصيل'><input type='hidden' name='id' value='{case['id']}'></form>"
