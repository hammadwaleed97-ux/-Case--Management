...
.btn-open button {{background: linear-gradient(135deg, #2C4A73, #3A5F8A)!important; color: #C9A961!important; border:1px solid #C9A961!important; border-radius:5px!important; padding:2px 8px!important; font-weight:800!important; height:35px!important}}
...
if st.session_state.page == "الرئيسية":
    ...
    if not data["cases"]:
        ...
        cols = st.columns(len(sorted_cases))
    ...
    if case:
        ...
        # ====== 5. الحكم ======
        st.markdown("<div class='card'><div class='card-title card-title-5'
