...
# ==================== بداية قسم التسجيل ====================
    ...
    with st.form("form_case"):
        ...
        with col1:
            محكمة_نوع = st.selectbox("نوع المحكمة", ["الابتدائية", "استئناف القاهرة", "النقض", "الإدارية", "القضاء الإدارى", "الإدارية العليا"], key="sel_court_type")
        with col2:
...
# ==================== بداية قسم التفاصيل ====================
    ...
    if case:
        ...
        # ====== 5. الحكم ======
        st.markdown("<div class='card'><div class='card-title card-title-5'>5- بيانات الحكم</div>", unsafe_
