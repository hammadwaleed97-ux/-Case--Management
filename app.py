...
# ================================================
    ...
    # ===== دالة ازرار التصدير =====
    def export_buttons(df_data, filename):
        ...
        with c5: 
            excel_data = df_data.to_csv(index=False, encoding='utf-8-sig') if not df_data.empty else ""
            st.download_button("📊 تحميل Excel", data=excel_data, file_name=f"{filename}.xlsx", use_container_width=True, key=f"dl_excel_{filename}")
    ...
    with tab1:
        ...
        if st.button("🔍 عرض بيان الدعاوى المتداولة", use_container_width=True, type="primary", key="show1"):
            ...
            export_buttons(df_export, f"بيان_الدعاوى_المتداولة_{from_date}_{to_date}")
    ...
    with tab2:
        ...
        if st.button("🔍 عرض بيان الاحكام", use_container_width=True, type="primary", key="show2"):
            ...
            # ازرار التصدير تحت التقرير مباشرة
            export_buttons(df_export, f"بيان_الاحكام_{الحكم_نوع}_{from_date2}_{to_date2}")
