...
# ================================================
    ...
    def create_pdf(cases_list, filename, report_type, region, title):
        ...
        elements.append(Paragraph(arabic(f"تحر في {datetime.now().strftime('%Y-%m-%d')}"), styleN))
