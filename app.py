...
# ================================================
    ...
    def create_pdf(cases_list, filename, report_type, region, title):
        ...
        styleH = ParagraphStyle('Header', fontName='Cairo', fontSize=14, alignment=TA_CENTER, textColor=colors.HexColor('#D4AF37'))
        styleN = ParagraphStyle('Normal', fontName='Cairo', fontSize=10, alignment=TA_RIGHT)
        ...
        if cases_list:
            ...
            # تحويل كل الخلايا ل Paragraph عربي
            ...
            t.setStyle(TableStyle([
                ...
                ('ROWBACKGROUNDS', (0,1), (-1,-1), [colors.HexColor('#2A3A5E'), colors.HexColor('#1E2A47')])
            ]))
            elements.append(t)
    ...
    def create_word(cases_list, filename, report_type, region, title):
        doc = Document()
        for p in [doc.add_paragraph()]: p.alignment = WD_ALIGN_PARAGRAPH.CENTER
        ...
        doc.add_paragraph('الإدارة المركزية للإدارات القانونية').alignment = WD_ALIGN_PARAGRAPH.CENTER
        doc.add_paragraph('الإدارة العامة للقضايا').alignment = WD_ALIGN_PARAGRAPH.CENTER
        doc.add_paragraph(f'ديوان عام {region}').alignment = WD_ALIGN_PARAGRAPH.CENTER
