...
# ================================================
    ...
    # ===== دالة انشاء PDF مؤقته بدون خط خارجي =====
    def create_pdf(cases_list, filename, report_type, region, title):
        ...
        if cases_list:
            ...
            t.setStyle(TableStyle([
                ...
                ('ROWBACKGROUNDS', (0,1), (-1,-1), [colors.HexColor('#1E2A47'), colors.HexColor('#0A1428')])
            ]))
            elements.append(t)
    ...
    def create_word(cases_list, filename, report_type, region, title):
        ...
        if cases_list:
            if report_type == "متداولة":
                ...
                for i, h in enumerate(headers): hdr[i].text = h; hdr[i].paragraphs[0].runs[0].font.bold = True
            else:
