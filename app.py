...
# ==================================================================
    ...
    if case:
        ...
        st.markdown(f"<div class='card'><div class='card-title'>بيانات القضية</div><p><b>نوع:</b> {case['نوع']}</p><p><b>المحكمة:</b> {case['محكمة_اسم']}</p><p><b>المدعي:</b> {case['مدعي']}</p><p><b>المدعي عليه:</b> {case['مدعي_عليه']}</p><p><b>الموضوع:</b> {case['موضوع']}</p></div>", unsafe_allow_html=True)
    ...
    if case:
        ...
        with st.form("form_edit"):
            ...
            case['حالة'] = st.selectbox("حالة القضية", ["متداولة", "هيئة", "حكم"], index=["متداولة", "هيئة", "حكم"].index(case['حالة']))
            st.markdown("<div class='btn-save'>", unsafe_allow_html=True)
