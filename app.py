...
<style>
    ...
    * { font-family: 'Cairo', sans-serif !important; }
    ...
    /* تعديل 1: رجعنا الازرار في النص */
    div[data-testid="column"] { display: flex; justify-content: center; }
    
    /* تعديل 2: الليبل جوه الصفحات بقى ابيض عشان يبان */
    [data-testid="stForm"] label, .stMarkdown { color: #FFFFFF !important; font-weight: 700; }
    
    [data-testid="stExpander"] summary { color: #D4AF37 !important; font-weight: 900 !important; font-size: 18px !important; }
    ...
    .stTextArea > div > label { 
        color: #FFFFFF !important; /* بقى ابيض عشان يبان */
        font-weight: 700 !important; font-size: 16px !important;
    }
    
    [data-baseweb="popover"] ul { background-color: #FFFFFF !important; }
    [data-baseweb="popover"] li, [data-baseweb="popover"] span { color: #000 !important; font-weight: 700 !important; }
...
if st.session_state.page == "الرئيسية":
    ...
    with col2:
        ...
        if st.button("📚 المكتبة", key="btn_lib_1"):
