...
if st.session_state.page=="الإحصائيات":
    ...
    # ============================================================
# إدارة القضايا
# الجزء السابع : تحسين الواجهة النهائية + لوحة التحكم + الحماية
# ============================================================


# ============================================================
# تحسين شكل الجداول العربية
# ============================================================
...
def settings_page():
    ...
    نظام إدارة القضايا يحفظ جميع البيانات داخل قاعدة البيانات

    ولا يتم فقد البيانات عند تعديل الكود.
...
# ============================================================
# القائمة الجانبية المخفية للإدارة
# ============================================================
...
with st.sidebar:
    ...
    if admin_choice=="الإحصائيات":

        st.session_state.page="الإحصائيات"


    elif admin_choice=="الإعدادات":

        st.session_state.page="الإعدادات"


    elif admin_choice=="عن البرنامج":
...
# ============================================================
# تشغيل الصفحات الإضافية
# ============================================================


if st.session_state.page=="الإعدادات":

    settings_page()



if st.session_state.page=="عن البرنامج":
