    ...
    for area in sorted(set((u.get("insurance_area") or "غير محددة").strip() or "غير محددة" for u in users), key=lambda x:x.casefold()):
        ...
        for i,u in enumerate(area_users):
            with cols[i % 6]:
                ...
                job_value = "مدير عام" if (u.get("role") == "general_manager" or raw_job in ("مدير عام", "مدير عام", "مدير عام")) else (raw_job or role_label(u.get("role")))
...
def to_pdf(df, title, region):
    ...
    pdf.cell(cell_w, 8, fix_arabic('مدير عامالإدارات القانونية'), 0, 1, 'C')
...
if st.session_state.page == "تقارير":
  ...
  .stButton>button:hover {background: #B8860B!important; color: #000!important;}
    ...
    with tab1:
        ...
        with colB: مدير_عام1 = st.text_input("اسم مدير عامالإدارات القانونية", key="modir1")
    ...
    with tab2:
        ...
        with colB: مدير_عام2 = st.text_input("اسم مدير عامالإدارات القانونية", key="modir2")
    ...
    with tab4:
        ...
        with colB: مدير_عام_stat = st.text_input("اسم مدير عامالإدارات القانونية", key="modir_stat")
